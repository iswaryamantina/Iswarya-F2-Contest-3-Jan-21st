...
localStorage.setItem(
  "registeredEmails",
  JSON.stringify(["supddashing@gmail.com", "rudra.sro2@gmail.com"])
);
...
function validateForm() {
  ...
  if (
    ...
    errorPassword.innerHTML =
      "Password should have at least 8 characters, 1 lowercase, 1 uppercase, 1 number, and 1 special characters. ";
    errorMessage++;
  }
